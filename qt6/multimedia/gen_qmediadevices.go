...
func (this *QMediaDevices) Sender() *qt6.QObject {
	...
	_method_ret := qt6.UnsafeNewQObject(unsafe.Pointer(C.QMediaDevices_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
func (this *QMediaDevices) SenderSignalIndex() int {
	...
	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QMediaDevices_protectedbase_senderSignalIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
func (this *QMediaDevices) Receivers(signal string) int {
	...
	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QMediaDevices_protectedbase_receivers(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal_Cstring))
...
func (this *QMediaDevices) IsSignalConnected(signal *qt6.QMetaMethod) bool {
	...
	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QMediaDevices_protectedbase_isSignalConnected(&_dynamic_cast_ok, unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer())))
