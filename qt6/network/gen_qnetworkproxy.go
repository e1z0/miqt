...
func NewQNetworkProxyQuery5(other *QNetworkProxyQuery) *QNetworkProxyQuery {
	...
	return newQNetworkProxyQuery(C.QNetworkProxyQuery_new5(other.cPointer()))
}
...
func NewQNetworkProxyQuery7(hostname string, port int, protocolTag string) *QNetworkProxyQuery {
	...
	return newQNetworkProxyQuery(C.QNetworkProxyQuery_new7(hostname_ms, (C.int)(port), protocolTag_ms))
}
...
func NewQNetworkProxyQuery9(bindPort uint16, protocolTag string) *QNetworkProxyQuery {
	...
	return newQNetworkProxyQuery(C.QNetworkProxyQuery_new9((C.ushort)(bindPort), protocolTag_ms))
}
