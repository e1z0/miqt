...
func (this *QUdpSocket) SetOpenMode(openMode qt6.QIODeviceBase__OpenModeFlag) {
...
func (this *QUdpSocket) Sender() *qt6.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt6.UnsafeNewQObject(unsafe.Pointer(C.QUdpSocket_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
func (this *QUdpSocket) IsSignalConnected(signal *qt6.QMetaMethod) bool {
