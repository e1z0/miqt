...
// Sender can only be called from a QWebEngineUrlSchemeHandler that was directly constructed.
func (this *QWebEngineUrlSchemeHandler) Sender() *qt6.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt6.UnsafeNewQObject(unsafe.Pointer(C.QWebEngineUrlSchemeHandler_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
// SenderSignalIndex can only be called from a QWebEngineUrlSchemeHandler that was directly constructed.
func (this *QWebEngineUrlSchemeHandler) SenderSignalIndex() int {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QWebEngineUrlSchemeHandler_protectedbase_senderSignalIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// Receivers can only be called from a QWebEngineUrlSchemeHandler that was directly constructed.
func (this *QWebEngineUrlSchemeHandler) Receivers(signal string) int {
	signal_Cstring := C.CString(signal)
	defer C.free(unsafe.Pointer(signal_Cstring))

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QWebEngineUrlSchemeHandler_protectedbase_receivers(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal_Cstring))
...
// IsSignalConnected can only be called from a QWebEngineUrlSchemeHandler that was directly constructed.
func (this *QWebEngineUrlSchemeHandler) IsSignalConnected(signal *qt6.QMetaMethod) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QWebEngineUrlSchemeHandler_protectedbase_isSignalConnected(&_dynamic_cast_ok, unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer())))
