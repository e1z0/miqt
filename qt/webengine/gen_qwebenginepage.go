...
import (
	...
	"github.com/e1z0/miqt/qt/webchannel"
	"runtime"
	"runtime/cgo"
	"unsafe"
)
...
func (this *QWebEnginePage) Sender() *qt.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt.UnsafeNewQObject(unsafe.Pointer(C.QWebEnginePage_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
func (this *QWebEnginePage) IsSignalConnected(signal *qt.QMetaMethod) bool {
