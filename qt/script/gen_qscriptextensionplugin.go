...
// Sender can only be called from a QScriptExtensionPlugin that was directly constructed.
func (this *QScriptExtensionPlugin) Sender() *qt.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt.UnsafeNewQObject(unsafe.Pointer(C.QScriptExtensionPlugin_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
// SenderSignalIndex can only be called from a QScriptExtensionPlugin that was directly constructed.
func (this *QScriptExtensionPlugin) SenderSignalIndex() int {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QScriptExtensionPlugin_protectedbase_senderSignalIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// Receivers can only be called from a QScriptExtensionPlugin that was directly constructed.
func (this *QScriptExtensionPlugin) Receivers(signal string) int {
	signal_Cstring := C.CString(signal)
	defer C.free(unsafe.Pointer(signal_Cstring))

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QScriptExtensionPlugin_protectedbase_receivers(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal_Cstring))
...
// IsSignalConnected can only be called from a QScriptExtensionPlugin that was directly constructed.
func (this *QScriptExtensionPlugin) IsSignalConnected(signal *qt.QMetaMethod) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QScriptExtensionPlugin_protectedbase_isSignalConnected(&_dynamic_cast_ok, unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer())))
