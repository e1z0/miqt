...
func (this *QQmlWebChannel) Sender() *qt.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt.UnsafeNewQObject(unsafe.Pointer(C.QQmlWebChannel_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
func (this *QQmlWebChannel) IsSignalConnected(signal *qt.QMetaMethod) bool {
