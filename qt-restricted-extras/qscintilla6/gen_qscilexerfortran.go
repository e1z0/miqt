...
// ReadProperties can only be called from a QsciLexerFortran that was directly constructed.
func (this *QsciLexerFortran) ReadProperties(qs *qt6.QSettings, prefix string) bool {
	...
	_method_ret := (bool)(C.QsciLexerFortran_protectedbase_readProperties(&_dynamic_cast_ok, unsafe.Pointer(this.h), (*C.QSettings)(qs.UnsafePointer()), prefix_ms))
...
// WriteProperties can only be called from a QsciLexerFortran that was directly constructed.
func (this *QsciLexerFortran) WriteProperties(qs *qt6.QSettings, prefix string) bool {
	prefix_ms := C.struct_miqt_string{}
	prefix_ms.data = C.CString(prefix)
	prefix_ms.len = C.size_t(len(prefix))
	defer C.free(unsafe.Pointer(prefix_ms.data))
	...
	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QsciLexerFortran_protectedbase_writeProperties(&_dynamic_cast_ok, unsafe.Pointer(this.h), (*C.QSettings)(qs.UnsafePointer()), prefix_ms))
...
// Sender can only be called from a QsciLexerFortran that was directly constructed.
func (this *QsciLexerFortran) Sender() *qt6.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt6.UnsafeNewQObject(unsafe.Pointer(C.QsciLexerFortran_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
// SenderSignalIndex can only be called from a QsciLexerFortran that was directly constructed.
func (this *QsciLexerFortran) SenderSignalIndex() int {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QsciLexerFortran_protectedbase_senderSignalIndex(&_dynamic_cast_ok, unsafe.Pointer(this.h)))
...
// Receivers can only be called from a QsciLexerFortran that was directly constructed.
func (this *QsciLexerFortran) Receivers(signal string) int {
	signal_Cstring := C.CString(signal)
	defer C.free(unsafe.Pointer(signal_Cstring))

	var _dynamic_cast_ok C.bool = false
	_method_ret := (int)(C.QsciLexerFortran_protectedbase_receivers(&_dynamic_cast_ok, unsafe.Pointer(this.h), signal_Cstring))
...
// IsSignalConnected can only be called from a QsciLexerFortran that was directly constructed.
func (this *QsciLexerFortran) IsSignalConnected(signal *qt6.QMetaMethod) bool {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (bool)(C.QsciLexerFortran_protectedbase_isSignalConnected(&_dynamic_cast_ok, unsafe.Pointer(this.h), (*C.QMetaMethod)(signal.UnsafePointer())))
