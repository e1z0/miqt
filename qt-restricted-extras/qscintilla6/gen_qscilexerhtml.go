...
func (this *QsciLexerHTML) ReadProperties(qs *qt6.QSettings, prefix string) bool {
...
func (this *QsciLexerHTML) WriteProperties(qs *qt6.QSettings, prefix string) bool {
	prefix_ms := C.struct_miqt_string{}
	prefix_ms.data = C.CString(prefix)
	prefix_ms.len = C.size_t(len(prefix))
	defer C.free(unsafe.Pointer(prefix_ms.data))
...
func (this *QsciLexerHTML) Sender() *qt6.QObject {

	var _dynamic_cast_ok C.bool = false
	_method_ret := qt6.UnsafeNewQObject(unsafe.Pointer(C.QsciLexerHTML_protectedbase_sender(&_dynamic_cast_ok, unsafe.Pointer(this.h))))
...
func (this *QsciLexerHTML) IsSignalConnected(signal *qt6.QMetaMethod) bool {
