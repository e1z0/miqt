...
func (this *Konsole__Emulation) SendKeyEvent(param1 *qt.QKeyEvent) {
	C.Konsole__Emulation_sendKeyEvent(this.h, (*C.QKeyEvent)(param1.UnsafePointer()))
}
...
func (this *Konsole__Emulation) callVirtualBase_SendKeyEvent(param1 *qt.QKeyEvent) {

	C.Konsole__Emulation_virtualbase_sendKeyEvent(unsafe.Pointer(this.h), (*C.QKeyEvent)(param1.UnsafePointer()))

}
func (this *Konsole__Emulation) OnSendKeyEvent(slot func(super func(param1 *qt.QKeyEvent), param1 *qt.QKeyEvent)) {
...
func miqt_exec_callback_Konsole__Emulation_sendKeyEvent(self *C.Konsole__Emulation, cb C.intptr_t, param1 *C.QKeyEvent) {
	...
	gofunc((&Konsole__Emulation{h: self}).callVirtualBase_SendKeyEvent, slotval1)
