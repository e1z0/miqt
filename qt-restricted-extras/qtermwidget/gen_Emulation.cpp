...
void miqt_exec_callback_Konsole__Emulation_sendKeyEvent(Konsole__Emulation*, intptr_t, QKeyEvent*);
...
public:
	...
	// Subclass to allow providing a Go implementation
	virtual void sendKeyEvent(QKeyEvent* param1) override {
		if (handle__sendKeyEvent == 0) {
			Konsole__Emulation::sendKeyEvent(param1);
			return;
		}
		
		QKeyEvent* sigval1 = param1;

		miqt_exec_callback_Konsole__Emulation_sendKeyEvent(this, handle__sendKeyEvent, sigval1);

		
	}

	friend void Konsole__Emulation_virtualbase_sendKeyEvent(void* self, QKeyEvent* param1);
...
void Konsole__Emulation_sendKeyEvent(Konsole__Emulation* self, QKeyEvent* param1) {
	self->sendKeyEvent(param1);
}
...
void Konsole__Emulation_virtualbase_sendKeyEvent(void* self, QKeyEvent* param1) {

	( (MiqtVirtualKonsoleEmulation*)(self) )->Konsole::Emulation::sendKeyEvent(param1);
